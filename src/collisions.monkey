Class Collision
	...
	Function LineToTFormPoly:Int( line_x1:Float, line_y1:Float, line_x2:Float, line_y2:Float,xy:Float[], poly_x:Float=0, poly_y:Float=0,rot:Float=0, scale_x:Float=1, scale_y:Float=1,handle_x:Float=0, handle_y:Float=0,origin_x:Float=0, origin_y:Float=0 )
		...
		Local linexy1:Float[2]
		linexy1[0] = line_x1
		linexy1[1] = line_y1
		
		TFormGlobalToLocal(linexy1,poly_x,poly_y,rot,scale_x,
							scale_y,handle_x,handle_y,origin_x,origin_y)
							
		Local linexy2:Float[2]
		linexy2[0] = line_x2
		linexy2[1] = line_y2
		
		TFormGlobalToLocal(linexy2,poly_x,poly_y,rot,scale_x,
							scale_y,handle_x,handle_y,origin_x,origin_y)
		
		Return LineToPoly(linexy1[0],linexy1[1],linexy2[0],linexy2[1],xy)
	End Function
	...
	Function PointInTFormPoly:Int( point_x:Float, point_y:Float, xy:Float[],poly_x:Float=0, poly_y:Float=0, rot:Float=0,scale_x:Float=1, scale_y:Float=1,handle_x:Float=0, handle_y:Float=0,origin_x:Float=0, origin_y:Float=0 )
		...
		TFormGlobalToLocal(pointxy,poly_x,poly_y,rot,scale_x,
							scale_y,handle_x,handle_y,origin_x,origin_y)
	...
	Function TFormPoly:Float[]( xy:Float[], tform_x:Float=0, tform_y:Float=0, rot:Float=0,scale_x:Float=1, scale_y:Float=1,handle_x:Float=0, handle_y:Float=0,origin_x:Float=0, origin_y:Float=0 )
		...
		For Local i:Int=0 Until tform_xy.Length Step 2
			...
			Local mag:Float=Sqrt(tform_xy[x]*tform_xy[x]+tform_xy[y]*tform_xy[y])
			Local ang:Float=ATan2(tform_xy[y],tform_xy[x])
			tform_xy[x]=Cos(ang-rot)*mag
			tform_xy[y]=Sin(ang-rot)*mag
	...
	Function TFormGlobalToLocal( point_xy:Float[],tform_x:Float=0, tform_y:Float=0, rot:Float=0,scale_x:Float=1, scale_y:Float=1,handle_x:Float=0, handle_y:Float=0,origin_x:Float=0, origin_y:Float=0 )		
		point_xy[0]-=origin_x
		point_xy[1]-=origin_y
		...
		Local mag:Float=Sqrt(point_xy[0]*point_xy[0]+point_xy[1]*point_xy[1])
		Local ang:Float=ATan2(point_xy[1],point_xy[0])
		point_xy[0]=Cos(ang+rot)*mag
		point_xy[1]=Sin(ang+rot)*mag
